            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="menu.php"><i class="fa fa-list"></i> Menü <span class="label label-success pull-right"></span></a></li>
                  <li><a href="slider.php"><i class="fa fa-image"></i> Slider <span class="label label-success pull-right"></span></a></li>
                  <li><a href="icerik.php"><i class="fa fa-file-text"></i> İçerik <span class="label label-success pull-right"></span></a></li>
                  <li><a href="mesajlar.php"><i class="fa fa-envelope"></i> Mesajlar <span class="label label-success pull-right"></span></a></li>
