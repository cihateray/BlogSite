                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <div align="right" class="col-md-6">
                      <a href="icerik-ekle.php"><button class="btn btn-success"><i class="fa fa-plus" arida-hidden="true">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center"><a href="icerik-duzenle.php?icerik_id=<?php echo $icerikcek['icerik_id']?>"><button style="width: 80px;" class="btn btn-primary btn-xs"><i class="fa fa-pencil" arida-hidden="true"></i> Düzenle</button></a></td>
                            <td class="text-center"><a href="../netting/islem.php?iceriksil=ok&icerik_id=<?php echo $icerikcek['icerik_id']?>"><button style="width: 80px;" class="btn btn-danger btn-xs"><i class="fa fa-trash" arida-hidden="true"></i> Sil</button></a></td>
                            </td>
                          </tr>   
                          <?php } ?>   
