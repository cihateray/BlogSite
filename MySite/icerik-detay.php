					...
					<div class="col-md-12">
						...
						<span class="thumb-info thumb-info-side-image thumb-info-no-zoom mt-xl">
							<span class="thumb-info-side-image-wrapper p-none">
								<img src="../<?php echo $icerikcek['icerik_resimyol']; ?>" class="img-responsive" alt="" style="width: 320px; height: 190px; padding: 15px;">
							</a>
						</span>
		...
		<div class="col-md-3">
			<aside class="sidebar">
				...
				<form id="contactForm" action="php/contact-form.php" method="POST">
					...
					<div class="row">
						<div class="col-md-12">
							<input type="submit" value="Send Message" class="btn btn-primary" data-loading-text="Gönderiliyor...">
