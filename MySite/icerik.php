...
<div role="main" class="main">
	<div class="container">
		<div class="row pt-xl">
			<div class="col-md-9">
				<h1 class="mt-xl mb-none">İçeriik</h1>
						...
						<div class="col-md-12">
							...
							<span class="thumb-info thumb-info-side-image thumb-info-no-zoom mt-xl">
								<span class="thumb-info-side-image-wrapper p-none">
									<img src="../<?php echo $icerikcek['icerik_resimyol']; ?>" class="img-responsive" alt="" style="width: 350px; height: 220px; padding: 15px;">
								</span>
								<span class="thumb-info-caption">
									<span class="thumb-info-caption-text">
										...
										<p style="font-size: 30px;"><?php echo substr($icerikcek['icerik_detay'],0,250);?>...</p>
